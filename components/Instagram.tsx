      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto mb-12">
          {reels.map((reel, index) => (
            ...
            >
              ...
              >
                <div className="w-full h-full bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end p-4">
                  <div className="text-white flex items-center gap-2">
                    ...
                    <span className="font-mono text-xs font-bold uppercase tracking-wider">Watch on Instagram</span>
                  </div>
                </div>
              </div>
            </motion.a>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-b from-accent-500 to-accent-700 hover:from-accent-400 hover:to-accent-600 text-black font-bold text-base sm:text-lg rounded-sm transition-all uppercase tracking-wider border-2 border-accent-800 shadow-[0_4px_0_0_rgba(0,0,0,0.6),0_0_24px_rgba(234,88,12,0.4)] active:translate-y-0.5 min-h-[44px]"
